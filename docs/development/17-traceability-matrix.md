...
| REQ-002 | 多业务系统管理、选择和知识隔离 | P0 | AC-002 | `systems`, `knowledge`, `retrieval`, `web` | `backend/src/knowagent/systems/`, `backend/src/knowagent/knowledge/`, `backend/migrations/versions/baaf88cba66a_create_business_systems_and_owner_roles.py`, `backend/migrations/versions/3ba86a4c3d35_add_knowledge_publication_isolation_.py`, `backend/tests/unit/test_system_service.py`, `backend/tests/unit/test_knowledge_publication.py`, `backend/tests/integration/test_identity_api.py`, `frontend/src/api/client.ts`, `frontend/src/features/admin/SystemsPage.tsx`, `frontend/src/features/auth/UserHomePage.tsx`；`retrieval` 待实现 | implementing（系统管理、选择、知识表复合 `system_id` 外键、当前发布指针版本+文档+系统约束及强过滤仓储已完成；真实双系统检索零泄漏验收待 Phase 2/集成环境） |
...
| REQ-004 | 四类文档结构化解析、精确定位和可恢复索引 | P0 | AC-003, AC-009 | `documents`, `knowledge`, `worker`, `model-service` | `backend/src/knowagent/documents/`, `backend/src/knowagent/knowledge/`, `backend/src/knowagent/platform/object_store.py`, `backend/src/knowagent/platform/settings.py`, `backend/src/knowagent/worker/`, `backend/migrations/versions/d1a97d2e451b_create_document_ingestion_tables.py`, `backend/migrations/versions/3ba86a4c3d35_add_knowledge_publication_isolation_.py`, `backend/.env.example`, `backend/tests/unit/test_source_locator.py`, `backend/tests/unit/test_document_parsers.py`, `backend/tests/unit/test_document_chunking.py`, `backend/tests/unit/test_document_configuration.py`, `backend/tests/unit/test_document_ingestion_service.py`, `backend/tests/unit/test_ingestion_job.py`, `backend/tests/unit/test_ingestion_processor.py`, `backend/tests/unit/test_ingestion_repository.py`, `backend/tests/unit/test_knowledge_publication.py`, `backend/tests/unit/test_s3_object_store.py`, `backend/tests/unit/test_worker_tasks.py`, `backend/tests/integration/test_identity_api.py` | implementing（四类解析、结构化切分、精确定位、S3 对象存储、可恢复持久任务、版本/发布/隔离基础模型已完成；版本处理仍停在 `CHUNKED`，Embedding/可检索索引 Worker 编排待 Phase 2） |
