...
| REQ-004 | 四类文档结构化解析、精确定位和可恢复索引 | P0 | AC-003, AC-009 | `documents`, `knowledge`, `worker`, `model-service` | `backend/src/knowagent/documents/`, `backend/src/knowagent/knowledge/`, `backend/src/knowagent/knowledge/application/indexing.py`, `backend/src/knowagent/platform/object_store.py`, `backend/src/knowagent/platform/settings.py`, `backend/src/knowagent/worker/`, `backend/migrations/versions/d1a97d2e451b_create_document_ingestion_tables.py`, `backend/migrations/versions/3ba86a4c3d35_add_knowledge_publication_isolation_.py`, `backend/migrations/versions/c8784d439b23_add_phase2_vector_and_lexical_retrieval.py`, `backend/.env.example`, `backend/tests/unit/test_source_locator.py`, `backend/tests/unit/test_document_parsers.py`, `backend/tests/unit/test_document_chunking.py`, `backend/tests/unit/test_knowledge_indexing.py`, `backend/tests/unit/test_document_configuration.py`, `backend/tests/unit/test_document_ingestion_service.py`, `backend/tests/unit/test_ingestion_job.py`, `backend/tests/unit/test_ingestion_processor.py`, `backend/tests/unit/test_ingestion_repository.py`, `backend/tests/unit/test_knowledge_publication.py`, `backend/tests/unit/test_s3_object_store.py`, `backend/tests/unit/test_worker_tasks.py`, `backend/tests/integration/test_identity_api.py` | gap（批量 Embedding 与原子向量写回代码通过测试；缺少真实 S3 四格式组合、Embedding 服务联调和入库 Worker 索引阶段接线） |
| REQ-005 | 基于证据回答、引用溯源与历史引用快照 | P0 | AC-004, AC-008 | `retrieval`, `agent`, `conversations`, `knowledge`, `web` | `backend/src/knowagent/documents/domain/models.py`, `backend/src/knowagent/documents/application/chunking.py`, `backend/src/knowagent/retrieval/`, `backend/src/knowagent/agent/`, `backend/tests/unit/test_evidence_organizer.py`, `backend/tests/unit/test_answer_generation.py`, `backend/tests/unit/test_grounded_answer.py` | implementing（证据编号、来源元数据、locator 快照、声明级引用映射和逐字支撑验证已完成；问答 API、答案/引用持久化和历史读取待实现） |
...
| REQ-009 | 混合检索与 Rerank | P1 | AC-004, AC-008 | `retrieval`, `model-service`, `knowledge` | `backend/src/knowagent/retrieval/`, `backend/src/knowagent/knowledge/application/indexing.py`, `backend/migrations/versions/c8784d439b23_add_phase2_vector_and_lexical_retrieval.py`, `backend/tests/unit/test_basic_retrieval.py`, `backend/tests/unit/test_embedding_provider.py`, `backend/tests/unit/test_sqlalchemy_retrieval.py`, `backend/tests/unit/test_knowledge_indexing.py` | implementing（关键词/向量基础召回、RRF、数据库异常降级、结构化日志和指标端口已完成；真实服务、HNSW、Rerank 和质量调优待后续） |
